# In this script, we will build a PINN that solves the hydrogen molecular ion in 1D
...
class NeuralNetwork(nn.Module):
    def __init__(self):
        ...
        # We use this to store the energy and track it 
        self.E_history = [] 
...
# We define a trainable eigenvalue E (start near true ground state -0.597139)
E_ref =-0.5
